...
<body>
    ...
    <div class="content">
        ...
        <div class="row mt-4">
            <div class="col"></div>
            <div class="col-6">
                <form action="{{ route('admin.datadosen') }}" method="GET">
                    @csrf
        ...
        <div class="row mt-5">
            ...
            <div class="col"></div>
            <div class="col-2">
                <a class="btn btn-success" href="{{route('admin.tambahDataDosen') }}"
        ...
        <table class="table" style="margin-top: 10px">
            ...
            <tbody class="table-group-divider">
                @foreach ($data as $index => $datadosen)
                <tr>
                    <td scope="row">{{ $index + $data->firstItem() }}</td>
                    <td>
                        <img style="width: 50px" src="{{asset('/images/' . $datadosen->gambar) }}" alt="gambar dosen">
                    </td>
                    <td>{{ $datadosen->nama}}</td>
                    <td>{{ $datadosen->prodi}}</td>
                    <td>
                        <a class="btn btn-outline-warning" href="/admin/editDataDosen/{{ $datadosen->id }}">Edit</a>
                        <a class="btn btn-outline-danger" href="/admin/deleteDataDosen/{{ $datadosen->id }}">Delete</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
