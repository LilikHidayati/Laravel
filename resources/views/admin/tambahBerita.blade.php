                ...
                <div class="card mt-4" style="width: 800px">
                    <div class="card-body">
                        ...
                        <form action="{{ route('postTambahBerita') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-1">
                                <label class="text-secondary mb-2">Tanggal Terbit</label>
                                <input type="date" class="form-control border border-secondary form-control"
                                    name="tanggalTerbit" required value="{{ old('tanggalTerbit') }}">
                                <span class="text-danger">
                                    @error('tanggalTerbit')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group mt-1">
                                ...
                                <textarea class="form-control" name="konten"
                                    ...
                                    value="{{ old('konten') }}"></textarea>
                            </div>
                            <button type="submit" class="btn btn-success mt-5">Tambah Berita</button>
                        </form>
                    </div>
